// ===== DATA =====
let data={teams:[],players:[],coaches:[],practices:[],attendance:[],payments:[],injuries:[],notes:[],transfers:[],matches:[],messages:[]};
...
practices:[
{id:'e1',teamId:'1',type:'ვარჯიში',coachId:'c3',day:'ორშაბათი',time:'15:00'},
{id:'e2',teamId:'1',type:'ვარჯიში',coachId:'c3',day:'ოთხშაბათი',time:'15:00'},
{id:'e3',teamId:'1',type:'თამაში',coachId:'c3',day:'შაბათი',time:'11:00'},
{id:'e4',teamId:'2',type:'ვარჯიში',coachId:'c1',day:'ორშაბათი',time:'17:00'},
{id:'e5',teamId:'2',type:'ვარჯიში',coachId:'c1',day:'ოთხშაბათი',time:'17:00'},
{id:'e6',teamId:'2',type:'ვარჯიში',coachId:'c1',day:'პარასკევი',time:'17:00'},
{id:'e7',teamId:'2',type:'თამაში',coachId:'c1',day:'შაბათი',time:'14:00'},
{id:'e8',teamId:'3',type:'ვარჯიში',coachId:'c2',day:'სამშაბათი',time:'16:00'},
{id:'e9',teamId:'3',type:'ვარჯიში',coachId:'c2',day:'ხუთშაბათი',time:'16:00'},
{id:'e10',teamId:'3',type:'ამხანაგური',coachId:'c2',day:'კვირა',time:'12:00'},
{id:'e11',teamId:'4',type:'ვარჯიში',coachId:'c2',day:'ორშაბათი',time:'18:30'},
{id:'e12',teamId:'4',type:'თამაში',coachId:'c4',day:'კვირა',time:'16:00'}
],
attendance:[
...
data.practices.push({id:Date.now().toString(),type:document.getElementById('eventType').value,teamId:document.getElementById('practiceTeam').value,coachId:document.getElementById('practiceCoach').value,day:document.getElementById('practiceDay').value,time:document.getElementById('practiceTime').value});
...
// ===== UPDATE UI =====
function updateUI(){renderDashboard();renderTeams();renderPlayers();renderCoaches();renderSchedule();renderMatches();renderAttendance();renderFinances();renderCalendar();renderTransfers();renderRatings();renderMessages();populateAllSelects();renderNotifications();}
